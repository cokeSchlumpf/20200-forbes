 ...
 * 
 */
public class ReleaseBlockingKeyByCountryGenerator extends RecordBlockingKeyGenerator<Release, Attribute> {
	...
	public void generateBlockingKeys(Release record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		resultCollector.next(new Pair<String, Release>(record.getCountry(), record));
	}
