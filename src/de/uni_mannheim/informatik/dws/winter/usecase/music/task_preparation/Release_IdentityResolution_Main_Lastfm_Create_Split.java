 ...
 *
 */
public class Release_IdentityResolution_Main_Lastfm_Create_Split {
	/*
	 * Logging Options:
	...
	public static void main(String[] args) throws Exception {
		...
		gsTest.loadFromCSVFile(new File("usecase/music/goldstandard/musicbrainz_lastfm.csv"));
		...
		// activate logging
		matchingRule.activateDebugReport("usecase/music/output/musicbrainz_2_lastfm_log.csv", -1, gsTest);
		...
		evaluator.writeEvaluation(new File("usecase/music/output/musicbrainz_2_lastfm_evaluated_correspondences.csv"), correspondences, gsTest);
		evaluator.createTrainTestSplit(correspondences, gsTest, 0.7, new File("usecase/music/goldstandard/musicbrainz_lastfm_train.csv"), new File("usecase/music/goldstandard/musicbrainz_lastfm_test.csv"));
