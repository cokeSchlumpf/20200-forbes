 ...
 *
 */
public class Release_IdentityResolution_Main_Discogs_ML {
	/*
	 * Logging Options:
	...
	public static void main(String[] args) throws Exception {
		...
		gsTrain.loadFromCSVFile(new File("usecase/music/goldstandard/musicbrainz_discogs_train.csv"));
		...
		Performance perfTrain = rl.learnMatchingRule(musicbrainz, discogs, null, matchingRule, gsTrain);
