 ...
 * 
 */
public class ReleaseCountryComparatorLevenshtein implements Comparator<Release, Attribute> {
	...
	public double compare(Release entity1, Release entity2, Correspondence<Attribute, Matchable> corr) {
		...
		if(this.comparisonLog != null){
			...
			this.comparisonLog.setRecord1Value(entity1.getCountry());
			this.comparisonLog.setRecord2Value(entity2.getCountry());
