 ...
 * 
 */
public class ReleaseBlockingKeyByYearGenerator extends RecordBlockingKeyGenerator<Release, Attribute> {
	...
	public void generateBlockingKeys(Release record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		if (record.getDate() != null) {
			resultCollector.next(new Pair<String, Release>(Integer.toString(record.getDate().getYear()), record));
		}
	}
