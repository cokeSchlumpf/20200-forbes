 ...
 * 
 */
public class ReleaseBlockingKeyByLongestTokenInNameGenerator extends RecordBlockingKeyGenerator<Release, Attribute> {
	...
	public void generateBlockingKeys(Release record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		String[] tokens = record.getName().split("[^\\w']+");
		resultCollector.next(new Pair<String, Release>(getLongestString(tokens), record));
	}
