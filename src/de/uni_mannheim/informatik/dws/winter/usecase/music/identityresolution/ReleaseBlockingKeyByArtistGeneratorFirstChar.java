 ...
 * 
 */
public class ReleaseBlockingKeyByArtistGeneratorFirstChar extends RecordBlockingKeyGenerator<Release, Attribute> {
	/**
	 * 
	 */
	...
	public void generateBlockingKeys(Release record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		if (record.getArtist() != null) {
			resultCollector.next(new Pair<String, Release>(record.getArtist().substring(0, 1), record));
		}
