...
public class Release_DataFusion_Main {
	...
	public static void main(String[] args) throws Exception {
		...
		xmlReader.loadFromXML(new File("usecase/music/mapforce/discogs_target_schema.xml"),
		...
		xmlReader.loadFromXML(new File("usecase/music/mapforce/musicbrainz_target_schema.xml"),
		...
		discogs.setScore(1.0);
		musicbrainz.setScore(2.0);
		lastfm.setScore(3.0);
		...
		correspondences.loadCorrespondences(new File("usecase/music/output/musicbrainz_2_discogs_correspondences.csv"),
				musicbrainz, discogs);
		correspondences.loadCorrespondences(new File("usecase/music/output/musicbrainz_2_lastfm_correspondences.csv"), musicbrainz,
				lastfm);
