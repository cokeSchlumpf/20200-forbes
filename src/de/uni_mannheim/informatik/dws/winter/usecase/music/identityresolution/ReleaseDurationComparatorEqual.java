 ...
 * 
 */
public class ReleaseDurationComparatorEqual implements Comparator<Release, Attribute> {
	...
	public double compare(Release entity1, Release entity2, Correspondence<Attribute, Matchable> corr) {
		...
		if(entity1.getDuration()!=null && entity2.getDuration()!=null) {
			similarity = sim.calculate((int) entity1.getDuration(), (int) entity2.getDuration());
		}
