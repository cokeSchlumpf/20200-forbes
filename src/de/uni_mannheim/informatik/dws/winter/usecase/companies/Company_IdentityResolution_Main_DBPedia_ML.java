...
import de.uni_mannheim.informatik.dws.winter.usecase.companies.identityresolution.CompanyBlockingKeyByCountryGenerator;
import de.uni_mannheim.informatik.dws.winter.usecase.companies.identityresolution.CompanyBlockingKeyByFirstCharGenerator;
import de.uni_mannheim.informatik.dws.winter.usecase.companies.identityresolution.CompanyBlockingKeyByIndustryGenerator;
import de.uni_mannheim.informatik.dws.winter.usecase.companies.identityresolution.CompanyBlockingKeyByNameGenerator;
 ...
 *
 */
public class Company_IdentityResolution_Main_DBPedia_ML {
	...
	public static void main(String[] args) throws Exception {	
		...
		// Load DBpedia
		DataSet<Company, Attribute> dbpedia = new HashedDataSet<>();
		...
		gsTrain.loadFromCSVFile(new File("usecase/company/goldstandard/forbes_dbpedia_train.csv"));

		// load the gold standard (test set)
		MatchingGoldStandard gsTest = new MatchingGoldStandard();
		gsTest.loadFromCSVFile(new File("usecase/company/goldstandard/forbes_dbpedia_test.csv"));
		...
		// activate logging
		// matchingRule.activateDebugReport("usecase/company/output/forbes_2_dbpedia_log.csv", -1, gsTest);
		...
		Performance perfTrain = rl.learnMatchingRule(forbes, dbpedia, null, matchingRule, gsTrain);
		...
		new CSVCorrespondenceFormatter().writeCSV(new File("usecase/company/output/forbes_2_dbpedia_correspondences.csv"), correspondences);
