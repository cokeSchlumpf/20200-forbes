 ...
 * 
 */
public class CompanyCityComparatorLevenshtein implements Comparator<Company, Attribute> {
	...
	public double compare(Company entity1, Company entity2, Correspondence<Attribute, Matchable> corr) {
		...
		if(this.comparisonLog != null){
			...
			this.comparisonLog.setRecord1Value(entity1.getCity());
			this.comparisonLog.setRecord2Value(entity2.getCity());
