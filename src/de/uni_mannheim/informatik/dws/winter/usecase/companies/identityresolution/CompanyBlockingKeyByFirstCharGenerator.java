 ...
 * 
 */
public class CompanyBlockingKeyByFirstCharGenerator extends RecordBlockingKeyGenerator<Company, Attribute> {
	...
	public void generateBlockingKeys(Company record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		if (record.getName() != null) {
			resultCollector.next(new Pair<String, Company>(record.getName().substring(0, 1), record));
		}
