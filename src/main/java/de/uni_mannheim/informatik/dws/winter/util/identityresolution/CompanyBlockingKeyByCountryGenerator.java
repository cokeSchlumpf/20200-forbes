 ...
 * 
 */
public class CompanyBlockingKeyByCountryGenerator extends RecordBlockingKeyGenerator<Company, Attribute> {
	...
	public void generateBlockingKeys(Company record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		resultCollector.next(new Pair<String, Company>(record.getCountry(), record));
