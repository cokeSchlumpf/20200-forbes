...
public final class FullContactResolutionML implements Runnable {
   ...
   public void run() {
      Operators.suppressExceptions(() -> {
         ...
         resolutionSupport.runML(
            "forbes", "fullcontact",
            forbes, fullContact, matchingRule, blocker, correspondencesPath, goldStandardTest, goldStandardTrain, transformer);
      });
   }
}
