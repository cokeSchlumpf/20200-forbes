 ...
 * 
 */
public class CountryFuserLongestString extends AttributeValueFuser<String, Company, Attribute> {
	...
	@Override
	public String getValue(Company record, Correspondence<Attribute, Matchable> corr) {
