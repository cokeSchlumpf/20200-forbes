 ...
 * 
 */
public class FoundedFuserFavourSource extends AttributeValueFuser<LocalDateTime, Company, Attribute> {

	public FoundedFuserFavourSource() {
		super(new FavourSources<LocalDateTime, Company, Attribute>());
	}
