 ...
 *
 */
package de.uni_mannheim.informatik.dws.winter.util.datafusion.fusers;

import de.uni_mannheim.informatik.dws.winter.datafusion.AttributeValueFuser;
import de.uni_mannheim.informatik.dws.winter.datafusion.conflictresolution.date.LatestDate;
 ...
 * 
 */
public class FoundedFuserNewest extends AttributeValueFuser<LocalDateTime, Company, Attribute> {

	public FoundedFuserNewest() {
		super(new LatestDate<Company, Attribute>());
	}
